...
| 测试用例                                        | 预期结果                                                   | 实际结果 |
| ----------------------------------------------- | ---------------------------------------------------------- | -------- |
| 开启hololens                                    | 播放hololens开机界面                                       |          |
| 在hololens端用手势打开project                   | 显示unity启动界面，播放一段音乐                            |          |
| 在hololens端用语音念出“project-name”打开project | 显示unity启动界面，播放一段音乐                            |          |
| 在project运行时说：”拍照“，开始场景识别         | hololens语音播报：1.”现在开始拍照“；2.大模型生成的场景描述 |          |
| 在project运行时说：”读文字“，开始文字识别       | hololens语音播报：1.”现在开始文字识别“；2.大模型读出文字   |          |
